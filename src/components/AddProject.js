                ...
                <form className="sideForm" onSubmit={this.postData}> 
                        <div className="divSideForm">
                            <label>Project Name:<br />
                                <input autoFocus placeholder="ex. Bank App" className="inputAdd" type="text" name="projectName" value={this.state.projectName} onChange={this.handleChange} required/>
                            </label>
                        </div>
                        <div className="divSideForm">
                            <label>Client:<br />
                                <input placeholder="ex. Chase" className="inputAdd" type="text" name="client" value={this.state.client} onChange={this.handleChange} required/>
                            </label>
                        </div>
                        <div className="divSideForm">
